...
export const TARGET_MARKETS = [
  ...
  { sector: 'AI & High-Performance Compute', description: 'GPU cluster facilities where cooling efficiency directly determines AI training throughput and operational cost. AMCORN monitors cooling performance continuously between cleans and dispatches automatically when thermal risk rises.' },
  { sector: 'Healthcare & Clinical Infrastructure', description: 'NHS data centres, private hospital infrastructure, and clinical facility data processing environments with CQC compliance requirements and zero tolerance for service interruption. Compliance reports formatted for NHS DSPT and CQC facility requirements.' },
  ...
  { sector: 'Life Sciences & Pharmaceutical', description: "GMP-regulated cleanrooms, pharmaceutical manufacturing environments, and biotech research facilities where contamination directly impacts product quality, MHRA compliance, and batch release. AMCORN's IoT monitoring and documented cleaning protocols are expanding into this sector in H2 2026.", badge: 'Launching H2 2026' },
]
